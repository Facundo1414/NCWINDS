...
const FlightDetails =()=>{
  ...
  return(
    <Box component='section' sx={{backgroundColor: 'white', color: 'black'}} borderRadius='12px' boxShadow='3' marginY='15px' padding='20px'>
      <Box component='div'>
        <Typography variant="h6" component='h6' sx={{fontWeight:'bold'}}>Filtrar por</Typography>
      </Box>
      ...
      <Box component='div' marginY='8px'>
       ...
       <div className="sliderStyles">
        <Slider sx={{color: '#0658BE', width:'90%'}} value={price} onChange={handleChangePrice} valueLabelDisplay="auto" aria-labelledby="range-slider" min={0} max={4000000}/>
        </div>
      </Box>
      ...
      <Box component='div' alignItems='center' marginY='6px'>
        ...
        <Typography>hrs {duracionVuelo[0]} - hrs {duracionVuelo[1]}</Typography>
        <div className="sliderStyles">
        <Slider sx={{color: '#0658BE', width:'90%'}} value={duracionVuelo} onChange={handleChangeDuracion} valueLabelDisplay="auto"  aria-labelledby="range-slider" min={0} max={48}/>
        </div> 
      </Box>
      ...
      <Box component='div' alignItems='center' marginY='6px' >
        ...
        <Typography>hrs {departureTime[0]} - hrs {departureTime[1]}</Typography>
        <div className="sliderStyles">
        <Slider sx={{color: '#0658BE', width:'90%'}} value={departureTime} onChange={handleChangeDepartureTime} valueLabelDisplay="auto"  aria-labelledby="range-slider" min={0} max={24}/>
        </div>
      </Box>     
      ...
      <Box component='div' alignItems='center' marginY='6px'>
        ...
        <Typography>{scales[0]} - {scales[1]}</Typography>
        <div className="sliderStyles">
        <Slider sx={{color: '#0658BE', width:'90%'}} value={scales} onChange={handleChangeScales} valueLabelDisplay="auto"  aria-labelledby="range-slider" min={0} max={10}/>
        </div>      
      </Box>
